...
interface Recipient {
 ...
 type DataType = 'profile' | 'messages' | 'notices' | 'quizzes' | 'quiz_questions' | 'quiz_submissions' | 'quiz_results' | 'quiz_audio' | 'lms_progress' | 'ca_projects' | 'ca_submissions' | 'ca_revisions' | 'sections' | 'content_updates';

type ActionType = 'submit_quiz' | 'retake_quiz' | 'submit_ca' | 'update_ca' | 'send_message' | 'mark_message_read' | 'mark_notice_read' | 'mark_all_messages_read' | 'mark_update_read' | 'mark_all_updates_read';
